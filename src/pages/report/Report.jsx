...
import { users as initialUsers } from "../report/data"; 
...
const Report = () => {
  ...
  return (
    <div className="bg-[#F9F9FA] rounded-2xl pb-6">
      <div className="mt-6 p-4 md:px-12 flex flex-col md:flex-row gap-3 md:items-center justify-between">
        ...
        <table className="min-w-full table-auto">
          <thead className="bg-Primary text-white">
            <tr>
              ...
              <th className="px-4 py-2 text-left">Reporting Date</th>
